namespace Scellecs.Morpeh.Helpers {
    ...
    public abstract class SimpleFixedSystem : IFixedSystem {
        [PublicAPI] protected bool inAwake;
        private Filter filter;
    ...
    public abstract class SimpleFixedSystem<T> : SimpleFixedSystem
            where T : struct, IComponent {
        private Stash<T> stash;
    ...
    public abstract class SimpleFixedSystem<T1, T2> : SimpleFixedSystem
            where T1 : struct, IComponent
            where T2 : struct, IComponent {
        private Stash<T1> stash1;
        private Stash<T2> stash2;
    ...
    public abstract class SimpleFixedSystem<T1, T2, T3> : SimpleFixedSystem
            where T1 : struct, IComponent
            where T2 : struct, IComponent
            where T3 : struct, IComponent {
        private Stash<T1> stash1;
